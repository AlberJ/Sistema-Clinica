<?php
	$this->assign('title','sistemaclinica | Consultas');
	...
	<script type="text/template" id="consultaCollectionTemplate">
		...
		<thead>
			<tr>
				...
				<th id="header_Cpfpaciente">Cpfpaciente<% if (page.orderBy == 'Cpfpaciente') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
		...
		<% items.each(function(item) { %>
			<tr id="<%= _.escape(item.get('codconsulta')) %>">
				...
				<td><%= _.escape(item.get('cpfpaciente') || '') %></td>
	...
	<script type="text/template" id="consultaModelTemplate">
		<form class="form-horizontal" onsubmit="return false;">
			<fieldset>
				...
				<div id="cpfpacienteInputContainer" class="control-group">
					<label class="control-label" for="cpfpaciente">Cpfpaciente</label>
					<div class="controls inline-inputs">
						<select id="cpfpaciente" name="cpfpaciente"></select>
						<span class="help-inline"></span>
					</div>
				</div>

<?php
	$this->assign('title','sistemaclinica | Home');
...
?>
	...
	<div class="container">
		...
		<<div class="hero-unit">
			<h1> Controle de Informações do Sistema</h1>
			<p>Aqui um usuário administrador poderá ter acesso as telas de controle das entidades do sistema, incluindo cadastros de pacientes, médicos, etc</p>

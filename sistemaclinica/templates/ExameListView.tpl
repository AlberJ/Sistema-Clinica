...
{block name=title}BANCOCLINICAMODELO | Exames{/block}
			...
			<fieldset>
				<div id="tipoexameInputContainer" class="control-group">
					...
					<div class="controls inline-inputs">
						<input type="text" class="input-xlarge" id="tipoexame" placeholder="Tipoexame" value="<%= _.escape(item.get('tipoexame') || '') %>" />

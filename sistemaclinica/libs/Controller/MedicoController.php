...
class MedicoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Crm,Nome,Telefone,Datanasc,Especialidade'
				, '%'.$filter.'%')
			);
	...
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('crm');
	...
	public function Create()
	{
		try
		{
			...
			$medico->Telefone = $this->SafeGetVal($json, 'telefone');
			$medico->Datanasc = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'datanasc')));
	...
	public function Update()
	{
		try
		{
			...
			$medico->Telefone = $this->SafeGetVal($json, 'telefone', $medico->Telefone);
			$medico->Datanasc = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'datanasc', $medico->Datanasc)));

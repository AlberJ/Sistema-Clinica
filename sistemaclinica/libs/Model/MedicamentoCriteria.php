...
require_once("DAO/MedicamentoCriteriaDAO.php");

/**
 * The MedicamentoCriteria class extends MedicamentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class MedicamentoCriteria extends MedicamentoCriteriaDAO
{

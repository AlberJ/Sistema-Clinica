...
require_once("DAO/ConsultaCriteriaDAO.php");

/**
 * The ConsultaCriteria class extends ConsultaDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConsultaCriteria extends ConsultaCriteriaDAO
{

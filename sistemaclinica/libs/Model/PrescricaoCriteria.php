...
require_once("DAO/PrescricaoCriteriaDAO.php");

/**
 * The PrescricaoCriteria class extends PrescricaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class PrescricaoCriteria extends PrescricaoCriteriaDAO
{
